...
internal sealed class GetPolicyFragmentDtoTests
{
    ...
    public async Task Returns_None_when_information_and_policy_files_are_missing()
    {
        ...
        await gen.SampleAsync(async tuple =>
        {
            ...
            var getPolicyFragmentDto = fixture.Resolve();

            // Act
            var dtoOption = await getPolicyFragmentDto(name, CancellationToken);
    ...
    private sealed record Fixture
    {
        ...
        public GetPolicyFragmentDto Resolve()
        {
            ...
            return ResourceModule.ResolveGetPolicyFragmentDto(provider);
        }
