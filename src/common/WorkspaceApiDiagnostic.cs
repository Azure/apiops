...
public sealed record WorkspaceApiDiagnosticResource : IResourceWithReference, IChildResource
{
    private WorkspaceApiDiagnosticResource() { }
    ...
    public Type DtoType { get; } = typeof(WorkspaceApiDiagnosticDto);
    ...
    public ImmutableDictionary<IResource, string> MandatoryReferencedResourceDtoProperties { get; } =
        ImmutableDictionary.Create<IResource, string>()
                           .Add(WorkspaceLoggerResource.Instance, nameof(WorkspaceApiDiagnosticDto.Properties.LoggerId));

    public IResource Parent { get; } = WorkspaceApiResource.Instance;

    public static WorkspaceApiDiagnosticResource Instance { get; } = new();
}
