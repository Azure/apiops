...
public static class DirectoryInfoExtensions
{
    ...
    public static Option<DirectoryInfo> GetParentDirectory(this DirectoryInfo directory) =>
...
{
    public static async ValueTask OverwriteWithJson<T>(this FileInfo file, T data, CancellationToken cancellationToken)
    {
        var options = JsonSerializerOptions.Web;
        options.WriteIndented = true;

        var binaryData = BinaryData.FromObjectAsJson(data, options);
