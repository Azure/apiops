...
2. Create a new pipeline based on [**run-extractor.yaml**](https://github.com/Azure/apiops/blob/main/tools/azdo_pipelines/run-extractor.yaml) in your repository.
