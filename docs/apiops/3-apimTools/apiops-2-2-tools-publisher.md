...
| CONFIGURATION_YAML_PATH | Path to the Yaml configuration file used to override different configurations (e.g. policy backend value,  namevalue pairs, just to name a few) when promoting across APIM environments (e.g. dev -> qa -> prod). You will need a unique Yaml configuration file per environment  (e.g. configuration.prod.yaml for production) when overriding configurations across environments. The provided pipelines assume that you will be utilizing a configuration for each environment. If you don't want to utilize the configuration file in your environment you will need to adapt the pipelines for your own environment by removing [this section for Azure Devops](https://github.com/Azure/apiops/blob/36c7e4e0ac2bd5a7fb64d85e5502c5b486ff63d9/tools/azdo_pipelines/run-publisher-with-env.yaml#L132) and [this section for Github](https://github.com/Azure/apiops/blob/36c7e4e0ac2bd5a7fb64d85e5502c5b486ff63d9/tools/github_workflows/run-publisher-with-env.yaml#L123) as well as [this section](https://github.com/Azure/apiops/blob/36c7e4e0ac2bd5a7fb64d85e5502c5b486ff63d9/tools/github_workflows/run-publisher-with-env.yaml#L160)    |
