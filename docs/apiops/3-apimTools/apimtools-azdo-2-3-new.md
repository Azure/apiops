...
7. Thats it. You are now ready to extract and publish your Azure APIM instance artifacts. For a list of supported artifacts refer to [this section ](apiops-7-3-supportedresources.md).